<table border="1" style="border-collapse: collapse; width: 100%; font-family: sans-serif;">
    <thead>
        <tr>
            <th colspan="25" style="background-color: #059669; color: #ffffff; font-size: 18px; font-weight: bold; text-align: center; height: 50px; vertical-align: middle;">
                DATA CALON SISWA - RA AN-NUUR ISLAMIC KINDERGARTEN
            </th>
        </tr>
        <tr>
            <th colspan="25" style="text-align: center; font-style: italic; background-color: #f3f4f6; height: 30px; vertical-align: middle;">
                Tanggal Export: {{ date('d-m-Y H:i') }} | Total Data: {{ count($applicants) }} Pendaftar
            </th>
        </tr>
        <tr>
            <th colspan="25" style="height: 15px; border: none;"></th>
        </tr>
        <tr>
